...
![](assets/wireframes/mobile-view.png
) 
...
![](assets/wireframes/desktop-view.png
) 
...
- This is a first stage of his Future Project:
    + After that, there should be a page for selling the projects or services provided by the owner of the site.
    + He can coordinate directly with his clients.
    + Clients can follow the progress of any assigned projects.
...
* CSS:  The project uses CSS to do Styling of the site.
